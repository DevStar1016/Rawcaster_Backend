                            ...
                            result_list.append(
                                {
                                    ...
                                    "event_melody_type":(1 if "Rawcaster Melody" in default_melody.title else 2 if "Your default" in default_melody.title else 3) if default_melody and default_melody.title else 3,
                                    "melodies": {
        ...
        if access_token == False:
            ...
            if get_user_count < 1:
                return {
                    ...
                    "referral_needed_count": 0 if referral_need_count > 0 else referral_need_count,
                    "current_page_no": 1,
                }
            else:
                default_page_size = 50

from sqlalchemy import Column, Integer, String,DateTime,Text,BigInteger,Time,ForeignKey
...
class GroupChat(Base):
    ...
    is_deleted_for_all=Column(TINYINT(1),default=0,comment=" 0 - No, 1 - all, 2-me ")

...
class NuggetsMaster(Base):
    ...
    nuggets_attachment = relationship(
        "NuggetsAttachment", back_populates="nuggets_master"
    )
    nugget_poll_option = relationship(
        "NuggetPollOption", back_populates="nuggets_master"
    )
    nugget_content_audio = relationship(
        "NuggetContentAudio", back_populates="nuggets_master"
    )

...
class Notification(Base):
    ...
    notification_type = Column(
        TINYINT,
        comment=" 1-nugget create, 2-Nugget Edit, 3-Nugget Comment, 4-nugget Reply, 5-Nugget Like, 6-nugget comment like, 7-Nugget reply like,8-Nugget share, 9-event create, 10-event edit, 11-friend request, 12-friend request approved,13-Invite Event,14-Live Event,15-Fans Follow/Unfollow,16-Poll Results,17-Group,18-My Nugget",
    )

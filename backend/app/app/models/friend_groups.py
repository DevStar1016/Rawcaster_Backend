...
class FriendGroups(Base):
    ...
    friend_group_members = relationship(
        "FriendGroupMembers", back_populates="friend_groups"
    )
    ...
    user_profile_display_group = relationship(
        "UserProfileDisplayGroup", back_populates="friend_groups"
    )

...
class NuggetsCommentsLikes(Base):
    ...
    comment_id=Column(Integer,comment=" nuggets_comments table id ")
    nugget_id=Column(Integer,comment=" nuggets table id ")
    created_date=Column(DateTime)
    status=Column(TINYINT,default=1)
    
    user=relationship("User",back_populates="nuggets_comments_likes")
    nuggets_comments=relationship("NuggetsComments",back_populates="nuggets_comments_likes")
